...
export const DeleteResultsDialog = ({
  formResults,
  onClose,
  onDeleted,
  ...
  const confirmationTarget =
    formResults.parentForm?.refNode?.displayName ?? formResults.displayName ?? formResults.name;
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error ? error.message : t("formResults.delete.validation.unexpectedError"),
      );
    } finally {
      setIsDeleting(false);
    }
    ...
    >
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px", padding: "20px" }}>
          ...
          >
            <Warning />
            <Typography variant="body">{t("formResults.delete.warning")}</Typography>
          </div>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            />
            <Typography variant="body">{t("formResults.delete.fields.allResults")}</Typography>
          </label>
          ...
          {hasValidRange && (
            <Typography variant="body" style={{ color: "var(--color-gray)" }}>
              {isCounting
                ? t("formResults.delete.count.loading")
                : t("formResults.delete.count.label", { count: submissionCount })}
            </Typography>
          )}

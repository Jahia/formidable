...
export const ExportResultsDialog = ({ formResults, onClose }: ExportResultsDialogProps) => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      setErrorMessage(
        error instanceof Error ? error.message : t("formResults.export.validation.unexpectedError"),
      );
    } finally {
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px", padding: "20px" }}>
          ...
          <label style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            />
            <Typography variant="body">{t("formResults.export.fields.allResults")}</Typography>
          </label>

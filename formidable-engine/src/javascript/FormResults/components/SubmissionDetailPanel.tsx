  ...
  return (
    ...
    >
      ...
      >
        <Paper
          hasPadding
          style={{ display: "flex", flexDirection: "column", gap: "16px", boxShadow: "none" }}
        >
          <div
            style={{
              display: "flex",
          ...
          <section>
            ...
            {submission.fieldValues.length === 0 ? (
              <Typography variant="body" isItalic>
                {t("formResults.detail.noValues")}
              </Typography>
            ) : (
              <div
                style={{
                    ...
                    <React.Fragment key={field.name}>
                      <div>
                        ...
                        {label && (
                          <Typography
                            variant="caption"
                            style={{ display: "block", color: "var(--color-gray)" }}
                          >
                            {field.name}
                          </Typography>
                        )}
                            ...
                            <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                              {file.thumbnailUrl ? (
                                <img
                                  ...
                                  alt={file.fileName}
                                  onClick={() =>
                                    isPreviewable(file.mimeType) && setPreviewFile(file)
                                  }
                                  style={{
                                    width: "150px",
                                    maxHeight: "150px",

...
| `packages/formidable-library/src/validationProps.ts` | `validationDataAttributes` — server-side helper to convert mixin props to data attributes (UI-contract package, published as `@jahia/formidable-library`, #178, #308) |

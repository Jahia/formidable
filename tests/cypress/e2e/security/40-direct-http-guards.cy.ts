...
describe("Security - direct HTTP submission guards", () => {
  ...
  before(() => {
    ...
    createPublishedLiveFormPage("security-public-form", "Security public form", [
  ...
  it("rejects non-multipart content before parsing the request body", () => {
    ...
    postDirectNonMultipartSubmission(publicFormId, withSameOriginHeaders()).then((response) => {

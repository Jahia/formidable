...
describe("Validation - 34 Multi-step validation", () => {
  ...
  it("blocks step navigation, focuses the first invalid field, and clears the error once valid", () => {
    createPublishedLiveFormPage("validation-step-form", "Validation Step Form", [
      getStepNode({
        name: "identityStepValidation",
        title: "Identity",
        label: "Identity",
        children: [
          withValidationMessages(getInputTextNode(STEP_ONE_FIELD), {
  ...
  it("validates the final step on submit and blocks submission until the field is corrected", () => {
    createPublishedLiveFormPage("validation-step-submit-form", "Validation Step Submit Form", [
      getStepNode({
        name: "firstStep",
        title: "Step One",
        label: "Step One",
      ...
      getStepNode({
        ...
        label: "Step Two",
        children: [
          withValidationMessages(getInputTextNode(FINAL_STEP_FIELD), {

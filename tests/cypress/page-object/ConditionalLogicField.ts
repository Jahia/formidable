...
export class ConditionalLogicField extends BaseComponent {
  ...
  private getDropdown(
    ...
    return this.getRule(ruleIndex).get().find(".moonstone-dropdown_container").eq(dropdownIndex);
  }
  ...
  private getOpenMenu(
    ...
    return this.getDropdown(ruleIndex, dropdownIndex).find(ConditionalLogicField.menuSelector, {
      timeout: 15000,
    });
  }
  ...
  addRule(): this {
    ...
    this.get()
      .find(ConditionalLogicRuleRow.defaultSelector, { timeout: 15000 })
      .should(($rules) => {
    ...
    this.getRule(0)
      .get()
      .find(".moonstone-dropdown_container", { timeout: 15000 })
  ...
  selectMenuItem(label: string): this {
    cy.get(ConditionalLogicField.menuSelector)
      .contains(".moonstone-menuItem", label)
      .trigger("click");
    return this;
  }

 ...
 * offered as a view choice), so the standalone page can evolve without touching the fullPage
 * or default views. The one difference with fullPage: the inner render is read-only, so the
 * Page Builder gets ONE module for the form node (this view's) instead of two nested boxes
 * for the same path. Editing the form itself (title, intro, buttons, responses) goes through

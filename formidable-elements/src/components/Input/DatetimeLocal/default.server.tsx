	...
	(
		{
			...
			helpText,
			defaultValue,
			"minBoundMode": minBoundMode,
			"maxBoundMode": maxBoundMode,
			"minRelativeAmount": minRelativeAmount,
			"minRelativeUnit": minRelativeUnit,
			"maxRelativeAmount": maxRelativeAmount,
			"maxRelativeUnit": maxRelativeUnit,
			min,
			max,
			step,
			required,

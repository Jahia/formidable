...
| `FMDB-002` | 400 | Required URL parameter `fid` is missing or blank |
...
| `FMDB-007` | 400 | Multipart parsing failed — possible causes: per-file size limit, total size limit, file count limit (CVE-2023-24998), or MIME type not in allowlist |

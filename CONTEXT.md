...
| `src/components/FieldActionList/hidden.authoring.server.tsx`, `src/components/FieldAction/hidden.authoring.server.tsx` | The zone under a field while authoring, replica of the form's actions zone (`ActionList/`, `FormAction/`) with the settings badges |
